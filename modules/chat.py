...
# ================= CONFIG =================
BUSINESS_GROUP_ID = me -1004294248635        # ← Yahan apna Group ID daalna (jaise -100xxxxxxxxxx)
...
User name: {user.first_name}"""
        try:
            ...
            final_reply = "Thank you for your message. I will inform Harry Boss."
    else:
        final_reply = "Thank you. I have noted your message and will inform Boss."
